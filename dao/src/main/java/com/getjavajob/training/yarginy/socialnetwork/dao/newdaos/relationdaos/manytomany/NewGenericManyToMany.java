package com.getjavajob.training.yarginy.socialnetwork.dao.newdaos.relationdaos.manytomany;
...
public abstract class NewGenericManyToMany<F extends Model, S extends Model> implements NewManyToManyDao<F, S> {
    @PersistenceContext
