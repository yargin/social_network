...
import com.getjavajob.training.yarginy.socialnetwork.dao.jpa.relationsdao.onetomany.JpaDialogMessagesDao;
...
public class DialogMessageDaoFacadeImpl implements DialogMessageDaoFacade {
    private final JpaDialogMessageDao dialogMessageDao;
    private final JpaDialogMessagesDao dialogsMessagesDao;

    public DialogMessageDaoFacadeImpl(JpaDialogMessageDao dialogMessageDao,
                                      JpaDialogMessagesDao dialogsMessagesDao) {
