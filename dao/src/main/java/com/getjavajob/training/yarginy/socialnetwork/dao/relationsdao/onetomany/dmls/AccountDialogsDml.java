...
//    private static final String SELECT_BY_BOTH = "SELECT " + AccountsTable.get("a1") + ", " +
...
//            " JOIN Accounts a2 ON Dialogs.second_id = a2.ID WHERE Dialogs.id = ? AND (a1.Id = ? OR a2.Id = ?) ";
    private static final String SELECT_BY_BOTH = "";
...
//            " = ?  OR " + DialogsTable.SECOND_ID + " = ?";
    private static final String SELECT_BY_ONE = "";
