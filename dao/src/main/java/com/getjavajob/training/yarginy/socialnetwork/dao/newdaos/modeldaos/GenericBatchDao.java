package com.getjavajob.training.yarginy.socialnetwork.dao.newdaos.modeldaos;
...
public abstract class GenericBatchDao<E extends Model> extends GenericDao<E> implements NewBatchDao<E> {
    @Override
    @Transactional
