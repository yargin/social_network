package com.getjavajob.training.yarginy.socialnetwork.dao.newdaos.relationdaos.manytomany.implementations;
...
import com.getjavajob.training.yarginy.socialnetwork.dao.newdaos.relationdaos.manytomany.NewGenericManyToMany;
...
@Repository
public class NewFriendshipRequestsDao extends NewGenericManyToMany<Account, Account> {
    @Override
