package com.getjavajob.training.yarginy.socialnetwork.dao.newdaos.relationdaos.selfmanytomany.implementations;
...
import com.getjavajob.training.yarginy.socialnetwork.dao.newdaos.relationdaos.selfmanytomany.NewGenericSelfManyToMany;
...
@Repository
public class NewFriendshipsDao extends NewGenericSelfManyToMany<Account> {
    @Override
